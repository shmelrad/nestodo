...
export class TagsService {
  ...
  async searchWorkspaceTags(workspaceId: number, query: string, userId: number): Promise<string[]> {
    await this.workspaceService.checkWorkspaceAccess(workspaceId, userId)
  ...
  async deleteWorkspaceTag(workspaceId: number, tagName: string, userId: number) {
    await this.workspaceService.checkWorkspaceAccess(workspaceId, userId)
